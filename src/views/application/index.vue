        ...
        <div class="model">
          ...
          >
            ...
            >
              <img
                v-if="itm.mouseLeave"
                :src="require(`../../assets/images/${itm.modelIcon || 'defaultDevice'}.png`)"
                alt=""
              >
              <img
                v-else
                :src="require(`../../assets/images/${itm.appGif || 'defaultDevice'}.gif`)"
                alt=""
              >
            </div>
          </div>
        ...
        <div class="model">
          ...
          >
            ...
            <div class="model-box-image">
              <img
                :src="require(`../../assets/images/${itm.imgUrl}.png`)"
                alt=""
              >
            </div>
          </div>
